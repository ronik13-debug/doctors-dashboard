...
# --- USA BENCHMARKS (Updated per user request) ---
# Derived from Total US Physicians (Approx Pop: 336M)
# Formula: (Total / 336,000,000) * 1000
AAMC_USA_BENCHMARKS = {
    'רפואה פנימית': 0.807,      # Internal Medicine (271,213)
    'רפואת המשפחה': 0.316,      # Family Medicine (106,055)
    'רפואת ילדים': 0.357,       # Pediatrics (119,989)
    'רפואה דחופה': 0.143,       # Emergency Medicine (48,182)
    'יילוד וגינקולוגיה': 0.157, # Obstetrics and Gynecology (52,809)
    'הרדמה': 0.192,             # Anesthesiology (64,537)
    'פסיכיאטריה': 0.174,        # Psychiatry (Est. ~70% of Psych/Neuro 83,554)
    'נוירולוגיה': 0.075,        # Neurology (Est. ~30% of Psych/Neuro 83,554)
    'רדיולוגיה אבחנתית': 0.203, # Radiology (68,325)
    'כירורגיה כללית': 0.136,    # Surgery (45,760)
    'אנטומיה פתולוגית': 0.102,  # Pathology (34,114)
    'מחלות עיניים': 0.077,      # Ophthalmology (25,888)
    'כירורגיה אורתופדית': 0.095,# Orthopaedic Surgery (31,920)
    'כירורגיה פלסטית ואסתטית': 0.027, # Plastic Surgery (9,119)
    'כירורגיה אורולוגית': 0.036,# Urology (12,102)
    'מחלות אף אוזן וגרון': 0.048, # Otolaryngology (16,160)
    'רפואה פיזיקלית ושיקום': 0.039, # Phys Med & Rehab (12,983)
    'דרמטולוגיה-מחלות עור ומין': 0.048, # Dermatology (16,090)
    'בריאות הציבור': 0.048,     # Preventive Medicine (16,126)
    'נוירוכירורגיה': 0.022,     # Neurological Surgery (7,468)
    'כירורגיה חזה ולב': 0.018,  # Thoracic Surgery (5,999)
    'אלרגולוגיה ואימונולוגיה קלינית': 0.019, # Allergy and Immunology (6,501)
    
    # Subspecialties removed as they are aggregated in IM in the new source:
    # Cardiology, Oncology, Gastro, Nephrology, etc.
}
